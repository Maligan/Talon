package com.greensock
{
   ...
   public final class OverwriteManager
   {
      ...
      public static function manageOverwrites(param1:TweenLite, param2:Object, param3:Array, param4:int) : Boolean
      {
         ...
         {
            _loc7_ = param3[_loc5_];
            if(!(_loc7_ == param1 || _loc7_.gc || !_loc7_.initted && _loc8_ - _loc7_.cachedStartTime <= 2.0e-10))
            {
               ...
               else if(_loc7_.cachedStartTime <= _loc8_ && _loc7_.cachedStartTime + _loc7_.totalDuration + 1.0e-10 > _loc8_ && !_loc7_.cachedPaused && !(param1.cachedDuration == 0 && _loc8_ - _loc7_.cachedStartTime <= 2.0e-10))
               {
