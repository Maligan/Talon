package talon.browser.plugins.desktop
{
	...
	import talon.browser.popups.widgets.TalonFeatherTextInput;
...
import talon.browser.plugins.desktop.commands.ChangeProfileCommand;
import talon.browser.plugins.desktop.commands.ChangeSettingCommand;
import talon.browser.plugins.desktop.commands.ChangeZoomCommand;
import talon.browser.plugins.desktop.commands.CloseDocumentCommand;
import talon.browser.plugins.desktop.commands.CloseWindowCommand;
import talon.browser.plugins.desktop.commands.CreateDocumentCommand;
import talon.browser.plugins.desktop.commands.OpenDocumentCommand;
import talon.browser.plugins.desktop.commands.OpenDocumentFolderCommand;
import talon.browser.plugins.desktop.commands.OpenGoToPopupCommand;
import talon.browser.plugins.desktop.commands.OpenOnlineDocumentationCommand;
import talon.browser.plugins.desktop.commands.OpenPopupCommand;
import talon.browser.plugins.desktop.commands.PublishCommand;
import talon.browser.plugins.desktop.commands.PublishScreenshotCommand;
import talon.browser.plugins.desktop.commands.RotateCommand;
import talon.browser.plugins.desktop.commands.ToggleFullScreenCommand;
import talon.browser.plugins.desktop.commands.UpdateCommand;
